                ...
                <div className="flex items-start justify-between">
                  <div>
                    <h1 className="text-7xl sm:text-8xl font-light tracking-wide leading-tight mb-8">
                      <AnimatedText text="Building digital" />
                      <br />
                      <AnimatedText text="experiences that" />
                      <br />
                      <AnimatedText text="matter." className="text-cyan-400" />
                    </h1>
                    <motion.p 
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      ...
                      <a href="https://x.com/XayHanmonty" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">
                        <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
                          <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                      </a>
                      <a href="mailto:contact@visitxay.com" className="hover:text-cyan-400 transition-colors">
                        <Mail size={28} />
                      </a>
                    </motion.div>
                  </div>
